...
<div class="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="relative">
                        ...
                        <input name="price" value="{{ old('price', $service->price) }}" type="number" step="0.01" id="price" class="block w-full pl-8 pr-4 py-3 border rounded-lg text-sm transition-all shadow-sm @error('price') border-red-500 focus:ring-red-500 focus:border-red-500 ring-1 ring-red-500/20 @else border-gray-300 focus:ring-bronze-gold focus:border-bronze-gold @enderror">
                    </div>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="relative">
                        ...
                        <input name="duration" value="{{ old('duration', $service->duration) }}" type="number" id="duration" class="block w-full pl-10 pr-4 py-3 border rounded-lg text-sm transition-all shadow-sm @error('duration') border-red-500 focus:ring-red-500 focus:border-red-500 ring-1 ring-red-500/20 @else border-gray-300 focus:ring-bronze-gold focus:border-bronze-gold @enderror">
                    </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" id="description" rows="5" class="block w-full px-4 py-3 border rounded-lg text-sm transition-all shadow-sm @error('description') border-red-500 focus:ring-red-500 focus:border-red-500 ring-1 ring-red-500/20 @else border-gray-300 focus:ring-bronze-gold focus:border-bronze-gold @enderror">{{ old('description', $service->description) }}</textarea>
                    @error('description') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                </div>
            </div>

            <div class="mt-12 flex items-center justify-end space-x-4 border-t border-gray-100 pt-8">
                <a href="{{ route('admin.services.index') }}" class="px-8 py-3 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-55 transition-all shadow-sm">
                    Cancelar
                </a>
