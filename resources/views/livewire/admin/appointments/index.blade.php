<div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
            ...
            <a href="{{ route('admin.appointments.create') }}" class="w-full md:w-auto bg-slate-dark hover:bg-slate-800 text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center justify-center transition-colors shadow-sm whitespace-nowrap" wire:navigate>
                    ...
                    @forelse($appointments as $appointment)
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <a href="{{ route('admin.appointments.edit', $appointment->id) }}" class="inline-flex items-center justify-center text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 p-2 rounded-md transition-colors mr-2" title="Editar Cita" wire:navigate>
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                @if($appointment->status !== 'completed')
                                    <button wire:click="markCompleted({{ $appointment->id }})" class="inline-flex items-center justify-center text-green-600 hover:text-green-900 bg-green-50 hover:bg-green-100 p-2 rounded-md transition-colors mr-2" title="Marcar como completada">
                                        <i class="fa-solid fa-check"></i>
                                    </button>
                                @endif
                                <button wire:click="delete({{ $appointment->id }})" class="inline-flex items-center justify-center text-red-600 hover:text-red-900 bg-red-50 hover:bg-red-100 p-2 rounded-md transition-colors" title="Eliminar Cita"><i class="fa-solid fa-trash-can"></i></button>
                            </td>
                        </tr>
                    @empty
                        <tr>
