    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            <h2 class="text-xl font-bold text-slate-dark">
                <i class="fa-solid fa-user-pen mr-2 text-bronze-gold"></i>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="w-48 h-48 rounded-full bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden transition-all group-hover:border-bronze-gold">
                            ...
                            @else
                                <div class="text-center p-4">
                                    ...
                                    <p class="text-xs text-gray-500">Cambiar foto</p>
                                </div>
                            @endif
                        </div>
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2 border-t border-gray-100 pt-6 mt-2">
                        ...
                        <p class="text-xs text-gray-400 mb-4 italic">Deja estos campos en blanco si no deseas cambiar la contraseña.</p>
                    </div>
