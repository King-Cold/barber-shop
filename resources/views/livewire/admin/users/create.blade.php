                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="name" type="text" id="name" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-bronze-gold focus:border-bronze-gold text-sm transition-all shadow-sm" placeholder="Ej. Administrador Principal">
                        </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="email" type="email" id="email" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-bronze-gold focus:border-bronze-gold text-sm transition-all shadow-sm" placeholder="correo@ejemplo.com">
                        </div>
                    ...
                    <!-- Role -->
                    <div class="col-span-2 md:col-span-1">
                        <label for="role" class="block text-sm font-semibold text-gray-700 mb-2">Rol del Sistema <span class="text-red-500">*</span></label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fa-solid fa-user-tag text-gray-400 text-xs"></i>
                            </div>
                            <select wire:model="role" id="role" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-bronze-gold focus:border-bronze-gold text-sm transition-all shadow-sm bg-white">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="password_confirmation" type="password" id="password_confirmation" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-bronze-gold focus:border-bronze-gold text-sm transition-all shadow-sm" placeholder="••••••••">
                        </div>
                    </div>
                </div>
            </div>
