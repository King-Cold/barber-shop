...
<head>
    ...
    <title>Cita Confirmada - {{ config('app.name') }}</title>
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 transform transition-all">
        <div class="bg-[#1F232D] p-8 text-center relative">
            ...
            <h1 class="text-white font-barber text-3xl uppercase tracking-widest mb-2">¡Confirmado!</h1>
            <p class="text-slate-400 text-sm">Tu cita ha sido agendada con éxito</p>
        </div>
        ...
        <div class="pt-16 pb-10 px-8">
            ...
            <div class="mt-10 text-center">
                <p class="text-slate-500 text-sm mb-6">Hemos enviado una copia de tu ticket a tu correo electrónico.</p>
